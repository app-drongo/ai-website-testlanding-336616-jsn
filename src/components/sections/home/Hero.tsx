...
const DEFAULT_HERO = {
  ...
  description:
    'Deploy production-ready applications with our cutting-edge development platform. Trusted by 50,000+ developers worldwide.',
  features: [
  ...
  statsLabel2: 'Active Users',
  statsValue2: '50K+ devs',
} as const;
